    ...
    elementoHtml.innerHTML = `
      ...
      <div class="card-body">
        ...
        <a href="${url_publicacion}"
          class="btn color1 border-dark border-3 letraF btn-outline focus-ring focus-ring-dark">Es el Inicio</a>
      </div>
      </div>
      `;
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="col">
              ...
              <a href="https://jeanpcarrillog.github.io?${fuente}#lectura" class="btn color1 border-dark border-3 letraF btn-outline focus-ring focus-ring-dark ${lectura_rapida}"  ><b>${boton_lectura_rapida}</b></a>
              </div>
              </div>
            </div>
            </div>
